...
<body>
    <form action="/admin/registMahasiswa" method="post">
        ...
        <div class="form-floating mb-3">
            <input type="text" name="name" class="form-control" id="name" placeholder="Password" value
                ="{{ old('name') }}">
        ...
        <div class="form-floating mb-3">
            <input type="text" name="nim" class="form-control" id="nim" placeholder="Password" value
                ="{{ old('nim') }}">
